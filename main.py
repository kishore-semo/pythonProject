...
# Screen Size global variable customize according to the screen
SCREEN_WIDTH = 480
SCREEN_HEIGHT = 480
...
# Movements and actions of the snake is written in this class
class Snake:
    def __init__(self):
        self.length = 1
        self.score = 0
...
# Random square pixel generator on the screen
class Food:
    def __init__(self):
        self.position = (0, 0)
...
def run():
    ...
    while running:
        ...
        text = font.render("Score {0}".format(world.score()), True, pygame.Color("black"))
